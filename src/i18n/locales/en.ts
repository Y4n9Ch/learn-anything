...
export const en: LocaleMessages = {
  cli: {
    ...
    initCommandDescription: 'Initialize DeepLearn learning skills in the current project',
    updateCommandDescription: 'Update DeepLearn skill files to latest version',
    ...
    updateComplete: 'DeepLearn skill files have been updated.',
    forceOption: 'Skip confirmation prompt',
    langOption: 'Display language: zh-CN or en (default: system locale)',
  },

  init: {
    header: '\n🧠 DeepLearn — AI-Powered Recursive Learning System\n',
    ...
    initComplete: '🎉 DeepLearn initialization complete!\n',
    globalDataPath: (dir: string) => `  Global learning data stored at ~/${dir}/`,
