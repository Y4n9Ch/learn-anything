...
export const zhCN: LocaleMessages = {
  cli: {
    ...
    initCommandDescription: '在当前项目初始化 DeepLearn 学习技能',
    updateCommandDescription: '更新 DeepLearn 技能文件到最新版本',
    ...
    updateComplete: 'DeepLearn 技能文件已更新。',
    forceOption: '跳过确认提示',
  ...
  init: {
    ...
    initComplete: '🎉 DeepLearn 初始化完成！\n',
    globalDataPath: (dir: string) => `  全局学习数据存储在 ~/${dir}/`,
